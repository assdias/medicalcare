            ...
            >
              ...
              >
                <q-item-section avatar top>
                  <q-icon name="place" size="34px" class="text-grey-8" />
                </q-item-section>
...
export default {
  ...
  setup(props) {
    ...
    const cidades = ref(null);
    cidades.value = props.list;

    const onShowEdit = (index, item) => {
      cidadeIndex.value = index;
      cidade.value.id = item.id;
      cidade.value.nome = item.nome;
      cidade.value.uf = item.uf;
